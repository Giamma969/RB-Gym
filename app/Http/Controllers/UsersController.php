...
class UsersController extends Controller
{
    ...
    public function addUser(Request $request){
        if($request->isMethod('post')){
            ...
            $user->save();
            return redirect()->action('UsersController@viewUsers')->with('flash_message_success','Utente aggiunto con successo');
        }
    ...
    public function editUser(Request $request, $id=null){
        if($request->isMethod('post')){
            ...
            $user->status=$data['status'];
            $user->save();
            return redirect()->action('UsersController@viewUsers')->with('flash_message_success','Utente modificato con successo!');
        }       
        $userDetails = User::find($id);
        return view('admin.users.edit_user')->with(compact('userDetails'));
    ...
    public function deleteUser($id=null){
        ...
        return redirect()->back()->with('flash_message_success','Utente eliminato con successo');
    }
