		...
		<div class="container">
			<div>
				<ol class="breadcrumb">
				  ...
				  <li><a style="color:#333 !important;" href="wishlist">Wishlist</a></li>
				</ol>
            </div>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
 					...
 					@if(Product::countWishedProducts()==0)
 						<p>La wishlist non contiene prodotti!</p>
					@endif
					...
					@if(empty($search_product))
						<?php /*<div align="center">{{ $productsWish->links() }}</div> */?>
					@endif 
