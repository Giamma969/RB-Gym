@php
	use App\Product;
	$count_search_product = Product::countSearchProducts($pattern);
@endphp
		...
		<div class="row">
			...
			<div class="col-lg-9 order-1 order-lg-2">
				<div class="filter-widget" style="margin-bottom:5px;">
					<h4 style="text-align:center; font-size:30px;" class="fw-title" >Products for "{{ $pattern }}"</h4>
				</div>
				<div class="product-show-option">
					<div class="row">
						<div class="col-lg-7 col-md-7">
							<div class="select-option">
								<form id="form_listing" name="form_listing" method="get" action="{{ url('/search-products')}}">{{csrf_field()}}
